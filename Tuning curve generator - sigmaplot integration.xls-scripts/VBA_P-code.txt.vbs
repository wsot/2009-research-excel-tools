' Processing file: Tuning curve generator - sigmaplot integration.xls
' ===============================================================================
' Module streams:
' _VBA_PROJECT_CUR/VBA/ThisWorkbook - 1157 bytes
' Line #0:
' 	Option  (Explicit)
' Line #1:
' _VBA_PROJECT_CUR/VBA/Sheet1 - 1097 bytes
' _VBA_PROJECT_CUR/VBA/ImportFrom - 9008 bytes
' Line #0:
' Line #1:
...
' 	EndSub 
' Line #121:
' _VBA_PROJECT_CUR/VBA/Module1 - 33363 bytes
' Line #0:
' 	Option  (Explicit)
' Line #1:
' 	Dim (Global) 
